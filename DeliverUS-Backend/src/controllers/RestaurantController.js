...
const show = async function (req, res) {
  ...
  try {
    ...
    const chooseOrder = restaurant.sortByPrice ? [{ model: Product, as: 'products' }, 'price', 'ASC'] : [{ model: Product, as: 'products' }, 'order', 'ASC']
...
const sortingProducts = async function (req, res) {
  try {
